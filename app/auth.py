...
SECRET = os.environ.get("EVENTS_SECRET_KEY", "")
if not SECRET:
    # dev fallback only; the Docker deploy always sets EVENTS_SECRET_KEY
    SECRET = "dev-" + hashlib.sha256(b"essfta-events-dev").hexdigest()

COOKIE = "essfta_events_session"
